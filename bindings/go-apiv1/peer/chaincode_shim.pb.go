...
const (
	...
	ChaincodeMessage_GET_HISTORY_FOR_KEYS  ChaincodeMessage_Type = 23
)
...
func (m *GetVersionForKey) Reset()         { *m = GetVersionForKey{} }
func (m *GetVersionForKey) String() string { return proto.CompactTextString(m) }
func (*GetVersionForKey) ProtoMessage()    {}
func (*GetVersionForKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5819fec16c96da2, []int{11}
}

func (m *GetVersionForKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetVersionForKey.Unmarshal(m, b)
}
func (m *GetVersionForKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetVersionForKey.Marshal(b, m, deterministic)
}
func (m *GetVersionForKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVersionForKey.Merge(m, src)
}
func (m *GetVersionForKey) XXX_Size() int {
	return xxx_messageInfo_GetVersionForKey.Size(m)
}
func (m *GetVersionForKey) XXX_DiscardUnknown() {
	xxx_messageInfo_GetVersionForKey.DiscardUnknown(m)
}

var xxx_messageInfo_GetVersionForKey proto.InternalMessageInfo

func (m *GetVersionForKey) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *GetVersionForKey) GetVersion() uint64 {
	if m != nil {
		return m.Version
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*GetVersionForKey)(nil), "protos.GetVersionForKey")
...
var fileDescriptor_e5819fec16c96da2 = []byte{
	...
	,
