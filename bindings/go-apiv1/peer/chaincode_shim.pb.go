...
const (
	...
	ChaincodeMessage_GET_VERSION_FOR_KEY   ChaincodeMessage_Type = 24
)
...
type GetVersionsForKey struct {
	Key                  string   `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	StartVersion         uint64   `protobuf:"varint,2,opt,name=startVersion,proto3" json:"startVersion,omitempty"`
	EndVersion           uint64   `protobuf:"varint,3,opt,name=endVersion,proto3" json:"endVersion,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetVersionsForKey) GetStartVersion() uint64 {
	if m != nil {
...
func (m *GetVersionsForKey) GetEndVersion() uint64 {
	if m != nil {
		return m.EndVersion
	}
	return 0
...
var fileDescriptor_e5819fec16c96da2 = []byte{
	...
	,
}
